...
很多人说Web后台开发人员每天的工作就是对数据库数据进行增删改查(CRUD)，可见CRUD开发的重要性。今天我将利用Django基于函数的视图编写一个任务管理小应用，实现创建(**Create**)一个任务，查看(**Retrieve**)任务清单和单个任务详情，更新(**Update**)一个任务和删除(**Delete**)一个任务。{: .fs-6 .fw-300 }
